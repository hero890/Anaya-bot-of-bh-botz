...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002088051309').split()]
...
SECOND_SHORTLINK_API = environ.get('SECOND_SHORTLINK_API', '4c10bc4686054199ba3f3658b09da4f855451b1f')
